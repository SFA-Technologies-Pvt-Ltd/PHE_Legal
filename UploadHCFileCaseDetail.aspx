<%@ Page Title="" Language="C#" MasterPageFile="~/Legal/MainMaster.master" AutoEventWireup="true" CodeFile="~/UploadHCFileCaseDetail.aspx.cs" Inherits="UploadHCFileCaseDetail" %>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 pt-3">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <asp:Button Text="Search" ID="btnSearch" runat="server" OnClick="btnSearch_Click" CssClass="btn btn-primary btn-block" />
                                                    </div>
                                                    <div class="col-md-4">
                                                        <a href="UploadHCFileCaseDetail.aspx" class="btn btn-secondary btn-block">Clear </a>
                                                    </div>
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <asp:GridView ID="grdExcel" runat="server" AutoGenerateColumns="false" OnDataBound="grdExcel_DataBound" OnPreRender="grdExcel_PreRender"
                                                CssClass="table" Width="100%" OnPageIndexChanging="grdExcel_PageIndexChanging" AllowPaging="true" PageSize="15">
                                                <RowStyle HorizontalAlign="Center" Font-Size="12" />
                                                <HeaderStyle Font-Bold="true" HorizontalAlign="Center" Font-Size="15" />
                                                <Columns>
                                                <%--    <asp:TemplateField HeaderText="S.No." ItemStyle-HorizontalAlign="Left">
                                                    ...
                                                    <asp:BoundField DataField="Filing No" HeaderText="Filing No" ItemStyle-HorizontalAlign="Left" />
