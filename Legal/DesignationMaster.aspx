                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtDeDesignation" runat="server" CssClass="form-control" placeholder="Designation Name" AutoComplete="off" MaxLength="50" onkeyup="javascript:capFirst(this);" onkeypress="return chcode();"></asp:TextBox>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="GrdDesignation" runat="server" CssClass="datatable table table-bordered table-hover" AutoGenerateColumns="false" OnRowCommand="GrdDesignation_RowCommand" DataKeyNames="Designation_Id">
                                            <Columns>
