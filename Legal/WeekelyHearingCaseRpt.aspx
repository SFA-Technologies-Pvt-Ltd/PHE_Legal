                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdSubjectWiseCasedtl" runat="server" CssClass="table table-bordered" EmptyDataText="NO RECORD FOUND" AutoGenerateColumns="false" OnRowCommand="grdSubjectWiseCasedtl_RowCommand" DataKeyNames="Case_ID" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdSubjectWiseCasedtl_PageIndexChanging">
                                            <Columns>
