<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OICWiseHearingDateShow.aspx.cs" Inherits="Legal_OICWiseHearingDateShow" %>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <fieldset>
                            <div class="row">
                                <asp:GridView runat="server" ID="grdData" EmptyDataText="No Record Found"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Status">
                                            <ItemTemplate>
                                                <asp:Label ID="lblIsOrderByDirection" Text='<%#Eval("Status") %>' runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
