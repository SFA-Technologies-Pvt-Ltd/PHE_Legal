...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    ...
    <asp:ValidationSummary ID="ValidationSummary2" runat="server" ShowMessageBox="true" ShowSummary="false" ValidationGroup="UpdateResponder" />
            ...
            <div class="modal-dialog" style="width: 80%; display: table-cell; vertical-align: middle;">
                <div class="modal-content" style="width: inherit; height: inherit; margin: 0 auto;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlOfficename_EditRes" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Respondent Name</label>
                                        <asp:TextBox ID="txtResponderName" runat="server" onkeyup="javascript:capFirst(this);" onkeypress="return chcode();" CssClass="form-control" AutoComplete="off" MaxLength="70"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" ValidationGroup="UpdateResponder" runat="server" Display="Dynamic" ControlToValidate="txtResponderNo"
                                        ...
                                        <asp:TextBox ID="txtResponderNo" runat="server" CssClass="form-control" onkeypress="return NumberOnly();" AutoComplete="off" MaxLength="10"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Department</label>
                                        <asp:TextBox ID="txtDepartment" runat="server" CssClass="form-control" AutoComplete="off" MaxLength="70" onkeyup="javascript:capFirst(this);" onkeypress="return chcode();"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Address</label>
                                        <asp:TextBox ID="txtAddress" runat="server" CssClass="form-control" AutoComplete="off" MaxLength="70" onkeyup="javascript:capFirst(this);" onkeypress="return chcode();"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
                    ...
                    <div class="modal-footer">
                        <asp:Button runat="server" CssClass="btn btn-success" ValidationGroup="UpdateResponder" Text="Update" ID="btnYes" Style="margin-top: 20px; width: 80px;" OnClick="btnAddResponder_Click" />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtEditDocumentsName" runat="server" CssClass="form-control" AutoComplete="off" MaxLength="70"  onkeyup="javascript:capFirst(this);"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ValidationGroup="EditHearing"
                                            ErrorMessage="Select Hearing Detail." ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Required !'></i>"
                                            ControlToValidate="ddlEditHearngDtl" Display="Dynamic" runat="server" InitialValue="0">
                                        </asp:RequiredFieldValidator>
                                        <asp:DropDownList ID="ddlEditHearngDtl" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlEditHearngDtl_SelectedIndexChanged" AutoPostBack="true">
                                ...
                                <div class="col-md-6" id="Editinst_Div" runat="server" visible="false">
                                    <div class="form-group">
                                        <label>Instruction</label>
                                            <asp:TextBox ID="txtInst_EditHearing" runat="server" onkeyup="javascript:capFirst(this);" onkeypress="return chcode();" CssClass="form-control" AutoComplete="off" MaxLength="100"></asp:TextBox>
                                        </div>
                                    </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            ...
                            <asp:LinkButton ID="lnkBack" runat="server" Visible="false" CssClass="btn-sm label-danger" OnClick="lnkBack_Click">Back</asp:LinkButton>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <asp:DetailsView ID="DtlViewCaseReport" runat="server" CssClass="table" AutoGenerateRows="false" BorderWidth="2px">
                                        ...
                                        <Fields>
                                            ...
                                            <asp:TemplateField HeaderText="WP Case No" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblWPCaseNo" runat="server" Text='<%# Eval("CaseNo") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="WP Case Year" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblWPCaseYear" runat="server" Text='<%# Eval("CaseYear") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Update Status">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCurrentCaseUpdate" runat="server" Text='<%# Eval("CurrentOfficeStatus") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Petitioner Advocate Mobile No.">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblpetiAdvocateMobileNO" runat="server" Text='<%# Eval("PetiAdvocateMobile") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:BoundField HeaderText="High Priority Case Status" DataField="HighPrioritiCasesStatus" />
                            ...
                            <div class="row pt-4">
                                <div class="col-md-9">
                                    <div class="table-responsive">
                                        <asp:GridView ID="GrdCaseDoc_FromDB" runat="server" CssClass="table table-bordered text-center" AutoGenerateColumns="false" DataKeyNames="CaseDoc_ID" OnRowCommand="GrdCaseDoc_FromDB_RowCommand">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="View" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="hyperViewDoc" runat="server" CssClass="fa fa-eye" ToolTip="View" Target="_blank" Enabled='<%#  Eval("Doc_Path").ToString() == "" ? false : true %>' NavigateUrl='<%# "../Legal/Documents/" +  Eval("Doc_Path") %>'></asp:HyperLink>
                                                        <asp:Label ID="lblCaseDoc" runat="server" Visible="false" Text='<%# Eval("Doc_Path") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                        ...
                        <fieldset id="Fieldset_HearingDtl" runat="server">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtHearingDate" runat="server" data-provide="datepicker" CssClass="form-control" AutoComplete="off" data-date-format="dd/mm/yyyy" data-date-autoclose="true" placeholder="DD/MM/YYYY" data-date-start-date="0d"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Hearing Detail</label><span style="color: red;"><b> * </b></span>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" ValidationGroup="Hearing"
                                                ErrorMessage="Select Hearing Detail." ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Required !'></i>"
                                                ControlToValidate="ddlHearingDtl" Display="Dynamic" runat="server" InitialValue="0">
                                            </asp:RequiredFieldValidator>
                                            <asp:DropDownList ID="ddlHearingDtl" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlHearingDtl_SelectedIndexChanged" AutoPostBack="true">
                                                 <asp:ListItem Value="0">Select</asp:ListItem>
                                                <asp:ListItem Value="1">Next Hearing Date</asp:ListItem>
                                                <asp:ListItem Value="2">Not Hearing</asp:ListItem>
                                                <asp:ListItem Value="3">Instruction By Court</asp:ListItem>
                                     ...
                                     <div class="col-md-3" id="Inst_AddHearing" runat="server" visible="false">
                                        <div class="form-group">
                                            <label>Instruction</label>
                                            <asp:TextBox ID="txtInst_AddHearing" runat="server" CssClass="form-control" AutoComplete="off" MaxLength="100"></asp:TextBox>
                                            </div>
                                         </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                                    ...
                                                    <div class="table-responsive">
                                                        <asp:GridView ID="GrdHearingDetail" runat="server" AutoGenerateColumns="false" CssClass="table" BorderWidth="2px">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Hearing" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                                    <ItemTemplate>
                                                                        <asp:HyperLink ID="lblHearingDoc" runat="server" Target="_blank" Enabled='<%#  Eval("HearingDoc").ToString() == "" ? false : true  %>' NavigateUrl='<%# "../Legal/HearingDoc/" + Eval("HearingDoc") %>' CssClass="fa fa-eye" ToolTip="View"></asp:HyperLink>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                                        </asp:GridView>
                            ...
                            <fieldset id="FiledSet_HearingDBDtl" runat="server">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="GrdHearingDtl_FromDB" runat="server" CssClass="table" BorderWidth="2px" AutoGenerateColumns="false" DataKeyNames="NextHearing_ID" OnRowCommand="GrdHearingDtl_FromDB_RowCommand" EmptyDataText="NO RECORD FOUND">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="S.No." ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Hearing Detail">
                                                      ...
                                                      <asp:TemplateField HeaderText="Instruction">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblInstruction" runat="server" Text='<%# Eval("InstructionByCourt") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnEditHearing" runat="server" CommandName="EditHearing" CommandArgument='<%# Eval("NextHearing_ID") %>' ToolTip="Edit"><i class="fa fa-edit"></i></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
                            ...
                            <div class="row">
                                <div class="col-md-3" id="CaseDispose_Div" runat="server">
                                    <div class="form-group">
                                        <label>
                                ...
                                <div class="col-md-3" id="caseDisposeYes" runat="server" visible="false">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RfvDisposeType" ValidationGroup="CaseDispose"
                                            ...
                                            ControlToValidate="ddlDisposalType" Display="Dynamic" InitialValue="0" runat="server">
                                        </asp:RequiredFieldValidator>
                                        <asp:DropDownList ID="ddlDisposalType" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlDisposalType_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-3" id="CaseDis_DateDiv" runat="server" visible="false">
                                    <div class="form-group">
                                        <label>
                                            Case Disposal Date
                                        </label>
                                        ...
                                        <asp:TextBox ID="txtCaseDisposeDate" runat="server" data-provide="datepicker" CssClass="form-control" AutoComplete="off" data-date-format="dd/mm/yyyy" data-date-autoclose="true" data-date-start-date="0d" placeholder="DD/MM/YYYY"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-4" id="CaseDis_OrderImpleDaysDiv" runat="server" visible="false">
                                    <div class="form-group">
                                        <label>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ValidationGroup="CaseDispose"
                                            ErrorMessage="Enter Order Implement Timeline (In Days)." ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Required !'></i>"
                                            ControlToValidate="txtOrderimpletimeline" Display="Dynamic" runat="server">
                                        </asp:RequiredFieldValidator>
                                        <asp:TextBox ID="txtOrderimpletimeline" runat="server" onkeypress="return NumberOnly();" CssClass="form-control" AutoComplete="off" MaxLength="3">
                                        </asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3" id="CaseDis_OrderDocDiv" runat="server" visible="false">
                                    <div class="form-group">
                                        <label>
                                            Order Document
                                        </label>  
                        ...
                        <fieldset id="Case_EditField" runat="server" visible="false">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Case No.</label>
                                        <asp:TextBox ID="txtCaseNo" runat="server" CssClass="form-control" AutoComplete="off" MaxLength="50"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RfvtxtOrder" ValidationGroup="CaseDtl"
                                            ...
                                            ControlToValidate="ddlCaseYear" InitialValue="0" Display="Dynamic" runat="server">
                                        </asp:RequiredFieldValidator>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtOfficeName" runat="server" CssClass="form-control" MaxLength="80" AutoComplete="off" onkeypress="return chcode();"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RfvtxtWPCaseNo" ValidationGroup="CaseDtl"
                                            ErrorMessage="Enter Updated Status." ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Required !'></i>"
                                            ControlToValidate="txtUpdatedCaseStatus" Display="Dynamic" runat="server">
                                        </asp:RequiredFieldValidator>
                                        <asp:TextBox ID="txtUpdatedCaseStatus" runat="server" CssClass="form-control" AutoComplete="off" MaxLength="70" onkeypress="return chcode();"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Justice's Name</label>
                                        <asp:TextBox ID="txtJusticeName" runat="server" onkeypress="return chcode();" CssClass="form-control" AutoComplete="off" MaxLength="70"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RegularExpressionValidator ID="revOICMobileNo" ValidationGroup="CaseDtl" runat="server" Display="Dynamic" ControlToValidate="txtPetiAdvocateMobileNO"
                                            ErrorMessage="Invalid Mobile No." SetFocusOnError="true"
                                            ForeColor="Red" ValidationExpression="^([6-9]{1}[0-9]{9})$"></asp:RegularExpressionValidator>
                                        <asp:TextBox ID="txtPetiAdvocateName" runat="server" CssClass="form-control" AutoComplete="off" MaxLength="10" onkeypress="return chcode();"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Advocate Mobile No.</label>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ValidationGroup="CaseDtl" runat="server" Display="Dynamic" ControlToValidate="txtPetiAdvocateMobileNo"
                                            ErrorMessage="Invalid Mobile No." SetFocusOnError="true"
                                            ForeColor="Red" ValidationExpression="^([6-9]{1}[0-9]{9})$"></asp:RegularExpressionValidator>
                                        <asp:TextBox ID="txtPetiAdvocateMobileNo" runat="server" CssClass="form-control" onkeypress="return NumberOnly();" AutoComplete="off" MaxLength="10"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>OIC Name</label><span style="color: red;"><b>*</b></span>
                                        <asp:RequiredFieldValidator ID="rfv_OicName" ValidationGroup="CaseDtl"
                                        ...
                                        <%-- <asp:TextBox ID="txtOicName" runat="server" CssClass="form-control" AutoComplete="off" MaxLength="70" onkeypress="return chcode();"></asp:TextBox>--%>
                                ...
                                <div class="col-md-3" id="Div_OicMobileNo" runat="server" visible="false">
                                    <div class="form-group">
                                        <label>OIC Mobile No.</label>
                                        <asp:RegularExpressionValidator ID="RfvOicMobileno" ValidationGroup="CaseDtl" runat="server" Display="Dynamic" ControlToValidate="txtOicMobileNo"
                                            ErrorMessage="Invalid Mobile No." SetFocusOnError="true"
                                            ForeColor="Red" ValidationExpression="^([6-9]{1}[0-9]{9})$"></asp:RegularExpressionValidator>
                                 ...
                                 <div class="col-md-3" id="Div_OicEmailID" runat="server" visible="false">
                                    <div class="form-group">
                                        <label>OIC Email-ID</label>
                                        <asp:TextBox ID="txtOicEmailID" runat="server" CssClass="form-control" AutoComplete="off" MaxLength="10"></asp:TextBox>
                                    </div>
                                </div>
                            <%--</div>
                            <div class="row">--%>
                            ...
                            <div class="row">
                                <div class="col-md-3" style="display: none;">
                                    <div class="form-group">
                                        <label>Respondent Type</label>
                                        <span style="color: red;"><b>*</b></span>
                                        <asp:DropDownList ID="ddlResponderType_Res" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <span style="color: red;"><b>*</b></span>
                                        <asp:RequiredFieldValidator ID="refvOfficetype" ValidationGroup="AddResponder"
                                            ErrorMessage="Select Office Type." ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Required !'></i>"
                                            ControlToValidate="ddlOfficeType_Res" Display="Dynamic" runat="server" InitialValue="0">
                                        </asp:RequiredFieldValidator>
                                        <asp:DropDownList ID="ddlOfficeType_Res" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlOfficeType_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Office Name</label>
                                        <span style="color: red;"><b>*</b></span>
                                        <asp:RequiredFieldValidator ID="rfvOfficName" ValidationGroup="AddResponder"
                                            ErrorMessage="Select Office Name." ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Required !'></i>"
                                            ControlToValidate="ddlOfficeName_Res" Display="Dynamic" runat="server" InitialValue="0">
                                        </asp:RequiredFieldValidator>
                                        <asp:DropDownList ID="ddlOfficeName_Res" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RFVtxtAddDocumentName" ValidationGroup="AddResponder"
                                            ...
                                            ControlToValidate="txtResponderName_Res" Display="Dynamic" runat="server">
                                        </asp:RequiredFieldValidator>
                                        <asp:TextBox ID="txtResponderName_Res" runat="server" CssClass="form-control" AutoComplete="off" MaxLength="70" onkeyup="javascript:capFirst(this);" onkeypress="return chcode();"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <span style="color: red;"><b>*</b></span>
                                        <asp:RequiredFieldValidator ID="rfvDesignationRes" ValidationGroup="AddResponder"
                                            ErrorMessage="Select Designation Name" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Required !'></i>"
                                            ControlToValidate="ddlDesignation_Res" Display="Dynamic" runat="server" InitialValue="0">
                                        </asp:RequiredFieldValidator>
                                        <asp:DropDownList ID="ddlDesignation_Res" runat="server" CssClass="form-control select2"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RfvtxtAddResponderNo" ValidationGroup="AddResponder"
                                            ...
                                            ControlToValidate="txtResponderNo_Res" Display="Dynamic" runat="server">
                                        </asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ValidationGroup="AddResponder" runat="server" Display="Dynamic" ControlToValidate="txtResponderNo_Res"
                                            ErrorMessage="Invalid Mobile No." SetFocusOnError="true"
                                            ForeColor="Red" ValidationExpression="^([6-9]{1}[0-9]{9})$"></asp:RegularExpressionValidator>
                                        <asp:TextBox ID="txtResponderNo_Res" runat="server" onkeypress="return NumberOnly();" CssClass="form-control" AutoComplete="off" MaxLength="10"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RfvtxtAddResponderDepartment" ValidationGroup="AddResponder"
                                            ...
                                            ControlToValidate="txtResponderDept_Res" Display="Dynamic" runat="server">
                                        </asp:RequiredFieldValidator>
                                        <asp:TextBox ID="txtResponderDept_Res" runat="server" CssClass="form-control" AutoComplete="off" MaxLength="70" onkeyup="javascript:capFirst(this);" onkeypress="return chcode();"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RfvtxtAddResponderAddress" ValidationGroup="AddResponder"
                                            ...
                                            ControlToValidate="txtResponderAdd_Res" Display="Dynamic" runat="server">
                                        </asp:RequiredFieldValidator>
                                        <asp:TextBox ID="txtResponderAdd_Res" runat="server" CssClass="form-control" AutoComplete="off" MaxLength="70" onkeyup="javascript:capFirst(this);" onkeypress="return chcode();"></asp:TextBox>
                                    </div>
                                </div>
