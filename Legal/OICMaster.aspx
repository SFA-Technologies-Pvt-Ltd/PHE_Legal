                                                ...
                                                <asp:GridView ID="gridoicmaster" AutoGenerateColumns="false" runat="server" DataKeyNames="OICMaster_ID" OnPageIndexChanging="gridoicmaster_PageIndexChanging" OnRowCommand="gridoicmaster_RowCommand"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Action">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="lnkEditView" runat="server" CommandArgument='<%# Eval("OICMaster_ID") %>' CommandName="EditDetails" ToolTip="Edit" CssClass="btn btn-primary"><i class="fa fa-edit"></i></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
