                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdMonthlyHearingdtl" runat="server" CssClass="table table-bordered" AutoGenerateColumns="false" OnRowCommand="grdMonthlyHearingdtl_RowCommand" DataKeyNames="Case_ID">
                                            <Columns>
