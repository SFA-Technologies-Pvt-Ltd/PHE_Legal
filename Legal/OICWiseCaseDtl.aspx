                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlOicName" runat="server" CssClass="form-control">
                                            ...
                                            <asp:ListItem Value="1">Srikant Parte</asp:ListItem>
                                            <asp:ListItem Value="2">Mohan Parte</asp:ListItem>
                                            <asp:ListItem Value="3">Ajay Mishra</asp:ListItem>
                                            <asp:ListItem Value="4">Varun Diwvedi</asp:ListItem>--%>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <%--<asp:RadioButtonList ID="rbWPCOnt" runat="server" RepeatDirection="Horizontal" CssClass="form-control" Style="padding: 0.3rem;">
                                ...
                                <div class="col-md-3 p-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <a href="OICWiseCaseDtl.aspx" class="btn btn-default btn-block">Clear</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdOICWiseCasedtl" runat="server" CssClass="table table-bordered" AutoGenerateColumns="false" OnRowCommand="grdOICWiseCasedtl_RowCommand" DataKeyNames="Case_ID">
                                            <Columns>
