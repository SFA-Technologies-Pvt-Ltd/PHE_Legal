<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderByDirectionEdit.aspx.cs" Inherits="Legal_OrderByDirectionEdit" %>
                        ...
                        <div style="width: 80%; display: table-cell; vertical-align: middle;">
                            <div class="modal-content" style="width: inherit; height: inherit; margin: 0 auto;">
                                ...
                                <div class="modal-footer">
                                    <asp:Button runat="server" CssClass="btn btn-success" Text="Update" ID="btnUpdate" Style="margin-top: 20px; width: 80px;" OnClick="btnUpdate_Click" />
                                    <asp:Button ID="btnNo" runat="server" CssClass="btn btn-danger" Text="Close" data-dismiss="modal" Style="margin-top: 20px; width: 60px;" OnClick="btnNo_Click" />
                                </div>
                                <div class="clearfix"></div>
                            </div>
                        </div>
