...
public partial class Legal_HearingDetails : System.Web.UI.Page
{
    DataSet ds;
    DataSet ds11;
        ...
        try
        {
            if (Session["Emp_ID"] != null)
            {
                if (!IsPostBack)
                {
                    ...
                    ds = objdb.ByProcedure("SpLegalCaseRegistration", new string[] { "flag", "Case_ID" }, new string[] { "11", ViewState["CID"].ToString() }, "dataset");
                    FillCaseDetail();
                    FillHearingDate();
                    FillExpenseGrid();
    ...
    protected void FillCaseDetail()
    {
        if (ViewState["CID"].ToString() != "" && ViewState["CID"].ToString() != null)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                //if (Case_Status == "Close" && ds11.Tables[0].Rows[0]["STATUS"].ToString() == "FALSE")
                //{
                ...
                //}
                //else if (Case_Status == "Close" && ds11.Tables[0].Rows[0]["STATUS"].ToString() == "TRUE")
                //{
