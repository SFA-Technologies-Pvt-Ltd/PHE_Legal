...
public partial class Mobile_ReportAll : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //}
            ds = obj.ByProcedure("USP_GetCaseRegisDetail", new string[] { "Casetype_ID",  "CaseNo", "Year", "CaseStatus"  }
                    , new string[] { ddlCaseType.SelectedValue,  ddlCaseNo.SelectedItem.Text, ddlCaseYear.SelectedItem.Text, ddlCaseStatus.SelectedItem.Text}, "dataset");
