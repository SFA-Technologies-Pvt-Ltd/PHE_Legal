lean returnStream, String method, TaskCompletionSource`1 completion, Int32 timeout, Task& task, Boolean& usedCache, Boolean asyncWrite, Boolean inRetry)
...
<br><hr>
<br>[<b style='color:Red;'>Date:</b> Thursday, February 10, 2022] & [<b style='color:Red;'>Time:</b> 1:56:54 PM]
...
Event Info :   at System.Data.SqlClient.SqlConnection.OnError(SqlException exception, Boolean breakConnection, Action`1 wrapCloseInAction)
   ...
   at System.Data.Common.DbDataAdapter.Fill(DataSet dataSet, Int32 startRecord, Int32 maxRecords, String srcTable, IDbCommand command, CommandBehavior behavior)
   at System.Data.Common.DbDataAdapter.Fill(DataSet dataSet)
   at APIProcedure.ByProcedure(String ProcedureName, String[] Parameter, String[] Values, String ByDataSetAlert) in c: