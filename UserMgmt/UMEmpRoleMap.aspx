<%@ Page Title="" Language="C#" MasterPageFile="~/Legal/MainMaster.master" AutoEventWireup="true" CodeFile="~/UserMgmt/UMEmpRoleMap.aspx.cs" Inherits="mis_UserMgmt_UMEmpRoleMap" %>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div id="divGrid" runat="server">
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group" style="padding-top: 2.25rem!important">
                                                        <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-primary btn-block" ValidationGroup="a" OnClientClick="return ValidatePage();" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
